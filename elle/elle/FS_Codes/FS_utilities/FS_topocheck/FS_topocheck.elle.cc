...
int TopologyChecks()
{
    ...
    printf("Detecting and deleting small flynns ...\n");
    DeleteSmallFlynns();  
    ...
    printf("Performing standard elle_gg topology checks ...\n");
    //ElleGGTopoChecksOLD();
    ElleGGTopoChecks();
    ...
    printf("Checkangle with %f or %f° ...\n",dMinAngle/(180/PI),dMinAngle);
    CheckAngle(dMinAngle/(180/PI));
    
    printf ("Checking if flynn needs split due to boundaries being too close ...\n");
...
/*
 * FS: Created by Jens, updated by Florian: 
 * Detects very tiny flynns with the following criteria:
 * 1.: 
 ...
 * -OR:-
 * 3.:
 * Flynn is dangling...see descriptions below
 * 
 * ATTENTION:
