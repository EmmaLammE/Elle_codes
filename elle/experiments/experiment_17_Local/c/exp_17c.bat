...
set COPY=copy /y
set MOVE=rename
cd %ELLEPATH%\..\experiments\experiment_17_Local\c
set BIN=%ELLEPATH%\binwx
set DELETE=del /Q
set COPY=copy /y
set MOVE=rename
set STARTFILE=locc.elle
set T=0
set LASTTIME=100
set TIMESTEP=1
set GGSTAGES=010
...
set SAVEINTVL=5
set SAVEALL=16
set BASINFILE=exp17c.in
set ROOTNAME=exp_17c
set GV_SAVE=0
set PLOTAX=0
set LIST=1 2 3 13  5 18 16
set R=%ROOTNAME%
...
if %%i EQU 5 (
echo %BIN%\elle_split -i tmp.elle -s 1 -f 1 -u 1 -n
%DEBUG% start /w %BIN%\elle_split -i tmp.elle -s 1 -f 1 -u 1 -n
if NOT ERRORLEVEL 0 GOTO END
